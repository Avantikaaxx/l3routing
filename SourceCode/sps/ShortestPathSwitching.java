		...
		ILinkDiscoveryListener, IDeviceListener, InterfaceShortestPathSwitching
{
    ...
    /**
     * To implement the  shortest path algorithm we implement Bellman-Ford using a queue to define which edges to explore next
     * 	This is a simplified version of the shortest path algorithms with the running time of O(V*E)
